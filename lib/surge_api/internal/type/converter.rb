    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { SurgeAPI::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { SurgeAPI::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            SurgeAPI::FilePart.new(value)
          in SurgeAPI::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in SurgeAPI::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [SurgeAPI::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: SurgeAPI::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in SurgeAPI::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in SurgeAPI::Internal::Type::Converter
              ...
              SurgeAPI::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(SurgeAPI::Internal::Type::Converter, T::Class[T.anything]) }
        end
