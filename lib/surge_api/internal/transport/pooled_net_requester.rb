      ...
      class PooledNetRequester
        ...
        class << self
          ...
          def calibrate_socket_timeout(conn, deadline)
            timeout = deadline - SurgeAPI::Internal::Util.monotonic_secs
        ...
        private def with_pool(url, deadline:, &blk)
          origin = SurgeAPI::Internal::Util.uri_origin(url)
          timeout = deadline - SurgeAPI::Internal::Util.monotonic_secs
          pool =
        ...
        def execute(request)
          ...
          enum = Enumerator.new do |y|
            ...
            raise SurgeAPI::Errors::APIConnectionError.new(url: url, request: req)
          end
