...
module SurgeAPI
  module Models
    ...
    class CampaignCreateParams < SurgeAPI::Internal::Type::BaseModel
      ...
      #
      #   @return [SurgeAPI::Models::CampaignCreateParams::Params::StandardCampaignParams, SurgeAPI::Models::CampaignCreateParams::Params::ExternalCampaignParams]
      required :params, union: -> { SurgeAPI::CampaignCreateParams::Params }
      ...
      module Params
        ...
        variant -> { SurgeAPI::CampaignCreateParams::Params::StandardCampaignParams }

        # Import an externally registered campaign from The Campaign Registry (TCR)
        variant -> { SurgeAPI::CampaignCreateParams::Params::ExternalCampaignParams }
        ...
        class StandardCampaignParams < SurgeAPI::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Symbol, SurgeAPI::Models::CampaignCreateParams::Params::StandardCampaignParams::UseCase>]
          required :use_cases,
                   -> { SurgeAPI::Internal::Type::ArrayOf[enum: SurgeAPI::CampaignCreateParams::Params::StandardCampaignParams::UseCase] }
          ...
          #
          #   @return [Symbol, SurgeAPI::Models::CampaignCreateParams::Params::StandardCampaignParams::Volume]
          required :volume, enum: -> { SurgeAPI::CampaignCreateParams::Params::StandardCampaignParams::Volume }
          ...
          #
          #   @return [Array<Symbol, SurgeAPI::Models::CampaignCreateParams::Params::StandardCampaignParams::Include>, nil]
          optional :includes,
                   -> { SurgeAPI::Internal::Type::ArrayOf[enum: SurgeAPI::CampaignCreateParams::Params::StandardCampaignParams::Include] }
          ...
          #   Some parameter documentations has been truncated, see
          #   {SurgeAPI::Models::CampaignCreateParams::Params::StandardCampaignParams} for
          #   more details.
          #
          #   Full campaign details for standard registration through Surge
          #
          ...
          #
          #   @param use_cases [Array<Symbol, SurgeAPI::Models::CampaignCreateParams::Params::StandardCampaignParams::UseCase>] A list containing 1-5 types of messages that will be sent with this campaign.
          #
          #   @param volume [Symbol, SurgeAPI::Models::CampaignCreateParams::Params::StandardCampaignParams::Volume] This will be one of the following:
          #
          #   @param includes [Array<Symbol, SurgeAPI::Models::CampaignCreateParams::Params::StandardCampaignParams::Include>] A list of properties that this campaign should include. These properties can be
          #
          ...
          #   charged as high volume numbers going forward.
          #
          # @see SurgeAPI::Models::CampaignCreateParams::Params::StandardCampaignParams#volume
          module Volume
            extend SurgeAPI::Internal::Type::Enum
        ...
        #   @return [Array(SurgeAPI::Models::CampaignCreateParams::Params::StandardCampaignParams, SurgeAPI::Models::CampaignCreateParams::Params::ExternalCampaignParams)]
      end
    end
  end
end
