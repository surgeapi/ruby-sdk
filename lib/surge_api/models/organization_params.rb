...
module SurgeAPI
  module Models
    class OrganizationParams < SurgeAPI::Internal::Type::BaseModel
      ...
      #
      #   @return [SurgeAPI::Models::OrganizationParams::Address, nil]
      optional :address, -> { SurgeAPI::OrganizationParams::Address }

      # @!attribute contact
      #   An object representing an individual who can be contacted if the carriers have
      #   any questions about the business.
      #
      #   @return [SurgeAPI::Models::OrganizationParams::Contact, nil]
      optional :contact, -> { SurgeAPI::OrganizationParams::Contact }, nil?: true
      ...
      #
      #   @return [Symbol, SurgeAPI::Models::OrganizationParams::IdentifierType, nil]
      optional :identifier_type, enum: -> { SurgeAPI::OrganizationParams::IdentifierType }, nil?: true

      # @!attribute industry
      #   The industry in which the organization operates.
      #
      #   @return [Symbol, SurgeAPI::Models::OrganizationParams::Industry, nil]
      optional :industry, enum: -> { SurgeAPI::OrganizationParams::Industry }, nil?: true
      ...
      #
      #   @return [Array<Symbol, SurgeAPI::Models::OrganizationParams::RegionsOfOperation>, nil]
      optional :regions_of_operation,
               -> {
                 SurgeAPI::Internal::Type::ArrayOf[enum: SurgeAPI::OrganizationParams::RegionsOfOperation]
               },
               nil?: true
      ...
      #   is traded.
      #
      #   @return [Symbol, SurgeAPI::Models::OrganizationParams::StockExchange, nil]
      optional :stock_exchange, enum: -> { SurgeAPI::OrganizationParams::StockExchange }, nil?: true
      ...
      #
      #   @return [Symbol, SurgeAPI::Models::OrganizationParams::Type, nil]
      optional :type, enum: -> { SurgeAPI::OrganizationParams::Type }, nil?: true
      ...
      #   {SurgeAPI::Models::OrganizationParams} for more details.
      #
      #   Parameters describing the legal entity on whose behalf the account will be
      #   operated.
      #
      #   @param address [SurgeAPI::Models::OrganizationParams::Address] The address of the organization's headquarters.
      #
      #   @param contact [SurgeAPI::Models::OrganizationParams::Contact, nil] An object representing an individual who can be contacted if the carriers have a
      #
      ...
      #
      #   @param identifier_type [Symbol, SurgeAPI::Models::OrganizationParams::IdentifierType, nil] The type of identifier being provided for the organization. Support for more val
      #
      #   @param industry [Symbol, SurgeAPI::Models::OrganizationParams::Industry, nil] The industry in which the organization operates.
      #
      #   @param mobile_number [String, nil] For sole proprietors, this must be a valid US mobile phone number to which a ver
      #
      #   @param regions_of_operation [Array<Symbol, SurgeAPI::Models::OrganizationParams::RegionsOfOperation>, nil] An array of regions in which the organization operates.
      #
      #   @param registered_name [String, nil] The legal name of the organization as registered with the IRS or other relevant
      #
      #   @param stock_exchange [Symbol, SurgeAPI::Models::OrganizationParams::StockExchange, nil] For publicly traded companies, this is the exchange on which the company's stock
      #
      #   @param stock_symbol [String, nil] For publicly traded companies, the ticker symbol for the company's stock
      #
      #   @param type [Symbol, SurgeAPI::Models::OrganizationParams::Type, nil] The type of organization
      #
      #   @param website [String, nil] The URL of the website for this organization. The website should be publicly ava

      # @see SurgeAPI::Models::OrganizationParams#address
      class Address < SurgeAPI::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {SurgeAPI::Models::OrganizationParams::Address} for more details.
        #
        #   The address of the organization's headquarters.
        #
      ...
      # @see SurgeAPI::Models::OrganizationParams#contact
      class Contact < SurgeAPI::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, SurgeAPI::Models::OrganizationParams::Contact::Title, nil]
        optional :title, enum: -> { SurgeAPI::OrganizationParams::Contact::Title }, nil?: true
        ...
        #   Some parameter documentations has been truncated, see
        #   {SurgeAPI::Models::OrganizationParams::Contact} for more details.
        #
        #   An object representing an individual who can be contacted if the carriers have
        #   any questions about the business.
        #
        ...
        #
        #   @param title [Symbol, SurgeAPI::Models::OrganizationParams::Contact::Title, nil] The job title of the individual.
        #
        #   @param title_other [String, nil] If `other` is provided for the `title` field, this field should be used to provi

        # The job title of the individual.
        #
        # @see SurgeAPI::Models::OrganizationParams::Contact#title
        module Title
      ...
      # values will be added in the future.
      #
      # @see SurgeAPI::Models::OrganizationParams#identifier_type
      ...
      # The industry in which the organization operates.
      #
      # @see SurgeAPI::Models::OrganizationParams#industry
      module Industry
        extend SurgeAPI::Internal::Type::Enum
      ...
      # is traded.
      #
      # @see SurgeAPI::Models::OrganizationParams#stock_exchange
      ...
      # The type of organization
      #
      # @see SurgeAPI::Models::OrganizationParams#type
      module Type
        extend SurgeAPI::Internal::Type::Enum
