...
module SurgeAPI
  module Models
    class CampaignParams < SurgeAPI::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Symbol, SurgeAPI::Models::CampaignParams::UseCase>]
      required :use_cases, -> { SurgeAPI::Internal::Type::ArrayOf[enum: SurgeAPI::CampaignParams::UseCase] }
      ...
      #
      #   @return [Symbol, SurgeAPI::Models::CampaignParams::Volume]
      required :volume, enum: -> { SurgeAPI::CampaignParams::Volume }
      ...
      #
      #   @return [Array<Symbol, SurgeAPI::Models::CampaignParams::Include>, nil]
      optional :includes, -> { SurgeAPI::Internal::Type::ArrayOf[enum: SurgeAPI::CampaignParams::Include] }
      ...
      #   {SurgeAPI::Models::CampaignParams} for more details.
      #
      ...
      #   charged as high volume numbers going forward.
      #
      # @see SurgeAPI::Models::CampaignParams#volume
      module Volume
        extend SurgeAPI::Internal::Type::Enum
