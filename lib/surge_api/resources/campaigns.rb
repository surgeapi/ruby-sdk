...
module SurgeAPI
  module Resources
    class Campaigns
      ...
      #
      # @overload create(account_id, consent_flow:, description:, message_samples:, privacy_policy_url:, use_cases:, volume:, tcr_id:, includes: nil, link_sample: nil, terms_and_conditions_url: nil, request_options: {})
      #
