...
module Surge
  module Models
    class CampaignParams < Surge::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Symbol, Surge::Models::CampaignParams::UseCase>]
      required :use_cases, -> { Surge::Internal::Type::ArrayOf[enum: Surge::CampaignParams::UseCase] }
      ...
      #
      #   @return [Symbol, Surge::Models::CampaignParams::Volume]
      required :volume, enum: -> { Surge::CampaignParams::Volume }
      ...
      #
      #   @return [Array<Symbol, Surge::Models::CampaignParams::Include>, nil]
      optional :includes, -> { Surge::Internal::Type::ArrayOf[enum: Surge::CampaignParams::Include] }
      ...
      #   {Surge::Models::CampaignParams} for more details.
      #
      ...
      #
      #   @param use_cases [Array<Symbol, Surge::Models::CampaignParams::UseCase>] A list containing 1-5 types of messages that will be sent with this campaign.
      #
      #   @param volume [Symbol, Surge::Models::CampaignParams::Volume] This will be one of the following:
      #
      #   @param includes [Array<Symbol, Surge::Models::CampaignParams::Include>] A list of properties that this campaign should include. These properties can be
      #
      ...
      #   charged as high volume numbers going forward.
      #
      # @see Surge::Models::CampaignParams#volume
      module Volume
        extend Surge::Internal::Type::Enum
