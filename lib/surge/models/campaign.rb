...
module Surge
  module Models
    ...
    class Campaign < Surge::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Symbol, Surge::Models::Campaign::Include>]
      required :includes, -> { Surge::Internal::Type::ArrayOf[enum: Surge::Campaign::Include] }
      ...
      #
      #   @return [Array<String>]
      required :message_samples, Surge::Internal::Type::ArrayOf[String]
      ...
      #
      #   @return [Array<Symbol, Surge::Models::Campaign::UseCase>]
      required :use_cases, -> { Surge::Internal::Type::ArrayOf[enum: Surge::Campaign::UseCase] }
      ...
      #
      #   @return [Symbol, Surge::Models::Campaign::Volume]
      required :volume, enum: -> { Surge::Campaign::Volume }
      ...
      #   Some parameter documentations has been truncated, see {Surge::Models::Campaign}
      #   for more details.
      #
      ...
      #
      #   @param includes [Array<Symbol, Surge::Models::Campaign::Include>] A list of properties that this campaign should include. These properties can be
      #
      ...
      #
      #   @param use_cases [Array<Symbol, Surge::Models::Campaign::UseCase>] A list containing 1-5 types of messages that will be sent with this campaign.
      #
      #   @param volume [Symbol, Surge::Models::Campaign::Volume] This will be one of the following:
      #
      ...
      #   charged as high volume numbers going forward.
      #
      # @see Surge::Models::Campaign#volume
      module Volume
        extend Surge::Internal::Type::Enum
