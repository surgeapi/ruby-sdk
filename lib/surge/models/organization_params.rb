...
module Surge
  module Models
    class OrganizationParams < Surge::Internal::Type::BaseModel
      ...
      #
      #   @return [Surge::Models::OrganizationParams::Address, nil]
      optional :address, -> { Surge::OrganizationParams::Address }

      # @!attribute contact
      #   An object representing an individual who can be contacted if the carriers have
      #   any questions about the business.
      #
      #   @return [Surge::Models::OrganizationParams::Contact, nil]
      optional :contact, -> { Surge::OrganizationParams::Contact }, nil?: true
      ...
      #
      #   @return [Symbol, Surge::Models::OrganizationParams::IdentifierType, nil]
      optional :identifier_type, enum: -> { Surge::OrganizationParams::IdentifierType }, nil?: true

      # @!attribute industry
      #   The industry in which the organization operates.
      #
      #   @return [Symbol, Surge::Models::OrganizationParams::Industry, nil]
      optional :industry, enum: -> { Surge::OrganizationParams::Industry }, nil?: true
      ...
      #
      #   @return [Array<Symbol, Surge::Models::OrganizationParams::RegionsOfOperation>, nil]
      optional :regions_of_operation,
               -> { Surge::Internal::Type::ArrayOf[enum: Surge::OrganizationParams::RegionsOfOperation] },
               nil?: true
      ...
      #   is traded.
      #
      #   @return [Symbol, Surge::Models::OrganizationParams::StockExchange, nil]
      optional :stock_exchange, enum: -> { Surge::OrganizationParams::StockExchange }, nil?: true
      ...
      #
      #   @return [Symbol, Surge::Models::OrganizationParams::Type, nil]
      optional :type, enum: -> { Surge::OrganizationParams::Type }, nil?: true
      ...
      #   {Surge::Models::OrganizationParams} for more details.
      #
      #   Parameters describing the legal entity on whose behalf the account will be
      #   operated.
      #
      #   @param address [Surge::Models::OrganizationParams::Address] The address of the organization's headquarters.
      #
      #   @param contact [Surge::Models::OrganizationParams::Contact, nil] An object representing an individual who can be contacted if the carriers have a
      #
      ...
      #
      #   @param identifier_type [Symbol, Surge::Models::OrganizationParams::IdentifierType, nil] The type of identifier being provided for the organization. Support for more val
      #
      #   @param industry [Symbol, Surge::Models::OrganizationParams::Industry, nil] The industry in which the organization operates.
      #
      #   @param mobile_number [String, nil] For sole proprietors, this must be a valid US mobile phone number to which a ver
      #
      #   @param regions_of_operation [Array<Symbol, Surge::Models::OrganizationParams::RegionsOfOperation>, nil] An array of regions in which the organization operates.
      #
      #   @param registered_name [String, nil] The legal name of the organization as registered with the IRS or other relevant
      #
      #   @param stock_exchange [Symbol, Surge::Models::OrganizationParams::StockExchange, nil] For publicly traded companies, this is the exchange on which the company's stock
      #
      #   @param stock_symbol [String, nil] For publicly traded companies, the ticker symbol for the company's stock
      #
      #   @param type [Symbol, Surge::Models::OrganizationParams::Type, nil] The type of organization
      #
      #   @param website [String, nil] The URL of the website for this organization. The website should be publicly ava

      # @see Surge::Models::OrganizationParams#address
      class Address < Surge::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {Surge::Models::OrganizationParams::Address} for more details.
        #
        #   The address of the organization's headquarters.
        #
      ...
      # @see Surge::Models::OrganizationParams#contact
      class Contact < Surge::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Surge::Models::OrganizationParams::Contact::Title, nil]
        optional :title, enum: -> { Surge::OrganizationParams::Contact::Title }, nil?: true
        ...
        #   Some parameter documentations has been truncated, see
        #   {Surge::Models::OrganizationParams::Contact} for more details.
        #
        #   An object representing an individual who can be contacted if the carriers have
        #   any questions about the business.
        #
        ...
        #
        #   @param title [Symbol, Surge::Models::OrganizationParams::Contact::Title, nil] The job title of the individual.
        #
        #   @param title_other [String, nil] If `other` is provided for the `title` field, this field should be used to provi

        # The job title of the individual.
        #
        # @see Surge::Models::OrganizationParams::Contact#title
        module Title
      ...
      # values will be added in the future.
      #
      # @see Surge::Models::OrganizationParams#identifier_type
      ...
      # The industry in which the organization operates.
      #
      # @see Surge::Models::OrganizationParams#industry
      module Industry
        extend Surge::Internal::Type::Enum
      ...
      # is traded.
      #
      # @see Surge::Models::OrganizationParams#stock_exchange
      ...
      # The type of organization
      #
      # @see Surge::Models::OrganizationParams#type
      module Type
        extend Surge::Internal::Type::Enum
