...
module Surge
  module Resources
    class Messages
      ...
      #
      # @param message_params [Surge::MessageParams] Payload for creating a message. Either an attachment or the body must be given.
      #
      # @param request_options [Surge::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [Surge::Models::Message]
      #
      # @see Surge::Models::MessageCreateParams
      def create(account_id, params)
        parsed, options = Surge::MessageCreateParams.dump_request(params)
        case parsed
