...
module Surge
  module Resources
    class Campaigns
      ...
      # {Surge::Models::CampaignCreateParams} for more details.
      #
      ...
      #
      # @return [Surge::Models::Campaign]
      #
      # @see Surge::Models::CampaignCreateParams
      def create(account_id, params)
        parsed, options = Surge::CampaignCreateParams.dump_request(params)
        @client.request(
          method: :post,
          path: ["accounts/%1$s/campaigns", account_id],
          body: parsed,
          model: Surge::Campaign,
          options: options
        )
      end
