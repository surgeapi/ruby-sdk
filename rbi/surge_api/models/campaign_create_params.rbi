      ...
      module Params
        ...
        class StandardCampaignParams < SurgeAPI::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T::Array[
                SurgeAPI::CampaignCreateParams::Params::StandardCampaignParams::UseCase::OrSymbol
              ]
            )
          end
          ...
          sig do
            returns(
              SurgeAPI::CampaignCreateParams::Params::StandardCampaignParams::Volume::OrSymbol
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  SurgeAPI::CampaignCreateParams::Params::StandardCampaignParams::Include::OrSymbol
                ]
              )
            )
          end
          ...
          module UseCase
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  SurgeAPI::CampaignCreateParams::Params::StandardCampaignParams::UseCase
                )
              end
            ...
            ACCOUNT_NOTIFICATION =
              T.let(
                :account_notification,
                SurgeAPI::CampaignCreateParams::Params::StandardCampaignParams::UseCase::TaggedSymbol
              )
            CUSTOMER_CARE =
              T.let(
                :customer_care,
          ...
          module Volume
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  SurgeAPI::CampaignCreateParams::Params::StandardCampaignParams::Volume
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            HIGH =
              T.let(
                :high,
                SurgeAPI::CampaignCreateParams::Params::StandardCampaignParams::Volume::TaggedSymbol
              )
            LOW =
              T.let(
                :low,
          ...
          module Include
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  SurgeAPI::CampaignCreateParams::Params::StandardCampaignParams::Include
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            LINKS =
              T.let(
                :links,
                SurgeAPI::CampaignCreateParams::Params::StandardCampaignParams::Include::TaggedSymbol
              )
            PHONE_NUMBERS =
              T.let(
                :phone_numbers,
        ...
        sig do
          override.returns(
            T::Array[SurgeAPI::CampaignCreateParams::Params::Variants]
          )
        end
        def self.variants
        end
