      ...
      class PooledNetRequester
        ...
        class << self
          ...
          sig do
            params(
              request:
                SurgeAPI::Internal::Transport::PooledNetRequester::Request,
        ...
        sig do
          params(
            request: SurgeAPI::Internal::Transport::PooledNetRequester::Request
        ...
        def self.new(
          size: SurgeAPI::Internal::Transport::PooledNetRequester::DEFAULT_MAX_CONNECTIONS
        )
        end
      end
    end
