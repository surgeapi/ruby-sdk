    ...
    module Type
      class BaseModel
        ...
        class << self
          ...
          sig do
            returns(
              T::Hash[
                Symbol,
                T.all(
                  SurgeAPI::Internal::Type::BaseModel::KnownField,
                  {
                    type_fn:
                      T.proc.returns(SurgeAPI::Internal::Type::Converter::Input)
                  }
                )
              ]
            )
          ...
          sig do
            returns(
              T::Hash[
                ...
                T.all(
                  SurgeAPI::Internal::Type::BaseModel::KnownField,
                  { type: SurgeAPI::Internal::Type::Converter::Input }
                )
              ]
            )
          end
          ...
          sig do
            params(
              ...
              spec: SurgeAPI::Internal::AnyHash
            ).void
          end
          ...
          sig do
            override
              .params(
                ...
                state: SurgeAPI::Internal::Type::Converter::CoerceState
              )
          ...
          sig do
            override
              .params(
                ...
                state: SurgeAPI::Internal::Type::Converter::DumpState
              )
        ...
        class << self
          ...
          sig do
            params(
              model: SurgeAPI::Internal::Type::BaseModel,
              convert: T::Boolean
            ).returns(SurgeAPI::Internal::AnyHash)
          end
        ...
        sig { overridable.returns(SurgeAPI::Internal::AnyHash) }
        def to_h
        end
