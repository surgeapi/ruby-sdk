    ...
    module Util
      ...
      class << self
        ...
        sig do
          params(
            data:
              T.any(Surge::Internal::AnyHash, T::Array[T.anything], T.anything),
            pick:
              T.nilable(
                T.any(
                  Symbol,
      ...
      class << self
        ...
        # @api private
        sig do
          params(parsed: Surge::Internal::Util::ParsedUri).returns(URI::Generic)
        end
        ...
        sig do
          params(
            lhs: Surge::Internal::Util::ParsedUri,
            rhs: Surge::Internal::Util::ParsedUri
          ).returns(URI::Generic)
        end
      ...
      class << self
        ...
        sig do
          params(lines: T::Enumerable[String]).returns(
            T::Enumerable[Surge::Internal::Util::ServerSentEvent]
          )
        end
      ...
      module SorbetRuntimeSupport
        ...
        class << self
          ...
          sig do
            params(
              type:
                T.any(Surge::Internal::Util::SorbetRuntimeSupport, T.anything)
            ).returns(T.anything)
          end
