...
module Surge
  module Models
    class Campaign < Surge::Internal::Type::BaseModel
      OrHash = T.type_alias { T.any(Surge::Campaign, Surge::Internal::AnyHash) }
      ...
      sig { returns(T::Array[Surge::Campaign::Include::TaggedSymbol]) }
      ...
      sig { returns(T::Array[Surge::Campaign::UseCase::TaggedSymbol]) }
      ...
      sig { returns(Surge::Campaign::Volume::TaggedSymbol) }
      ...
      sig do
        params(
          ...
          consent_flow: String,
          description: String,
          includes: T::Array[Surge::Campaign::Include::OrSymbol],
          message_samples: T::Array[String],
          privacy_policy_url: String,
          use_cases: T::Array[Surge::Campaign::UseCase::OrSymbol],
          volume: Surge::Campaign::Volume::OrSymbol,
          link_sample: String,
        ...
        override.returns(
          {
            ...
            consent_flow: String,
            description: String,
            includes: T::Array[Surge::Campaign::Include::TaggedSymbol],
            message_samples: T::Array[String],
            privacy_policy_url: String,
            use_cases: T::Array[Surge::Campaign::UseCase::TaggedSymbol],
            volume: Surge::Campaign::Volume::TaggedSymbol,
            link_sample: String,
            terms_and_conditions_url: String
          }
        )
      ...
      module Include
        ...
        TaggedSymbol = T.type_alias { T.all(Symbol, Surge::Campaign::Include) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        LINKS = T.let(:links, Surge::Campaign::Include::TaggedSymbol)
        PHONE_NUMBERS =
          T.let(:phone_numbers, Surge::Campaign::Include::TaggedSymbol)
        AGE_GATED = T.let(:age_gated, Surge::Campaign::Include::TaggedSymbol)
        DIRECT_LENDING =
          T.let(:direct_lending, Surge::Campaign::Include::TaggedSymbol)

        sig do
          override.returns(T::Array[Surge::Campaign::Include::TaggedSymbol])
        end
        def self.values
        end
      end
      ...
      module UseCase
        ...
        TaggedSymbol = T.type_alias { T.all(Symbol, Surge::Campaign::UseCase) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        ACCOUNT_NOTIFICATION =
          T.let(:account_notification, Surge::Campaign::UseCase::TaggedSymbol)
        CUSTOMER_CARE =
          T.let(:customer_care, Surge::Campaign::UseCase::TaggedSymbol)
        DELIVERY_NOTIFICATION =
          T.let(:delivery_notification, Surge::Campaign::UseCase::TaggedSymbol)
        FRAUD_ALERT =
          T.let(:fraud_alert, Surge::Campaign::UseCase::TaggedSymbol)
        HIGHER_EDUCATION =
          T.let(:higher_education, Surge::Campaign::UseCase::TaggedSymbol)
        MARKETING = T.let(:marketing, Surge::Campaign::UseCase::TaggedSymbol)
        POLLING_VOTING =
          T.let(:polling_voting, Surge::Campaign::UseCase::TaggedSymbol)
        PUBLIC_SERVICE_ANNOUNCEMENT =
          T.let(
            :public_service_announcement,
            Surge::Campaign::UseCase::TaggedSymbol
          )
        SECURITY_ALERT =
          T.let(:security_alert, Surge::Campaign::UseCase::TaggedSymbol)
        ...
        sig do
          override.returns(T::Array[Surge::Campaign::UseCase::TaggedSymbol])
        end
        def self.values
        end
      end
      ...
      module Volume
        ...
        TaggedSymbol = T.type_alias { T.all(Symbol, Surge::Campaign::Volume) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        HIGH = T.let(:high, Surge::Campaign::Volume::TaggedSymbol)
        LOW = T.let(:low, Surge::Campaign::Volume::TaggedSymbol)

        sig do
          override.returns(T::Array[Surge::Campaign::Volume::TaggedSymbol])
        end
        def self.values
        end
      end
