...
module Surge
  module Models
    class AccountParams < Surge::Internal::Type::BaseModel
      OrHash =
        T.type_alias { T.any(Surge::AccountParams, Surge::Internal::AnyHash) }
      ...
      # operated.
      sig { returns(T.nilable(Surge::OrganizationParams)) }
      attr_reader :organization

      sig { params(organization: Surge::OrganizationParams::OrHash).void }
      ...
      sig do
        params(
          ...
          organization: Surge::OrganizationParams::OrHash,
          time_zone: String
        ...
        override.returns(
          {
            name: String,
            brand_name: T.nilable(String),
            organization: Surge::OrganizationParams,
            time_zone: String
          }
        )
      end
