...
class SurgeAPI::Test::SingletonClient < SurgeAPI::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: SurgeAPI::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class SurgeAPI::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @surge = SurgeAPI::Test::SingletonClient.instance
  end
