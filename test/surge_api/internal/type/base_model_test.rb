...
class SurgeAPI::Test::PrimitiveModelTest < Minitest::Test
  A = SurgeAPI::Internal::Type::ArrayOf[-> { Integer }]
  H = SurgeAPI::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < SurgeAPI::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      SurgeAPI::Internal::Type::Unknown,
      SurgeAPI::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => SurgeAPI::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [SurgeAPI::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [SurgeAPI::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [SurgeAPI::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = SurgeAPI::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        SurgeAPI::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [SurgeAPI::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [SurgeAPI::Internal::Type::Boolean, true] => true,
      [SurgeAPI::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => SurgeAPI::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        SurgeAPI::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = SurgeAPI::Internal::Type::Converter.new_coerce_state
      SurgeAPI::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        SurgeAPI::Internal::Type::Converter.dump(target, input, state: state)
...
class SurgeAPI::Test::EnumModelTest < Minitest::Test
  class E0
    include SurgeAPI::Internal::Type::Enum
...
class SurgeAPI::Test::CollectionModelTest < Minitest::Test
  A1 = SurgeAPI::Internal::Type::ArrayOf[-> { Integer }]
  H1 = SurgeAPI::Internal::Type::HashOf[Integer]

  A2 = SurgeAPI::Internal::Type::ArrayOf[H1]
  H2 = SurgeAPI::Internal::Type::HashOf[-> { A1 }]

  A3 = SurgeAPI::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = SurgeAPI::Internal::Type::HashOf[Integer, nil?: true]
...
class SurgeAPI::Test::BaseModelTest < Minitest::Test
  class M1 < SurgeAPI::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < SurgeAPI::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < SurgeAPI::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, SurgeAPI::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = SurgeAPI::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = SurgeAPI::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(SurgeAPI::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue SurgeAPI::Errors::ConversionError => e
...
class SurgeAPI::Test::UnionTest < Minitest::Test
  class U0
    include SurgeAPI::Internal::Type::Union
  ...
  class M2 < SurgeAPI::Internal::Type::BaseModel
  ...
  class M4 < SurgeAPI::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, SurgeAPI::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < SurgeAPI::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, SurgeAPI::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class SurgeAPI::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include SurgeAPI::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [SurgeAPI::Internal::Type::Unknown, SurgeAPI::Internal::Type::Unknown] => true,
      [SurgeAPI::Internal::Type::Boolean, SurgeAPI::Internal::Type::Boolean] => true,
      [SurgeAPI::Internal::Type::Unknown, SurgeAPI::Internal::Type::Boolean] => false,
...
class SurgeAPI::Test::MetaInfoTest < Minitest::Test
  A1 = SurgeAPI::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = SurgeAPI::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
