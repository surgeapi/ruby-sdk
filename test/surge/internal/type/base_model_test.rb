...
class Surge::Test::PrimitiveModelTest < Minitest::Test
  A = Surge::Internal::Type::ArrayOf[-> { Integer }]
  H = Surge::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < Surge::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      Surge::Internal::Type::Unknown,
      Surge::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Surge::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Surge::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Surge::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Surge::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Surge::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Surge::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Surge::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Surge::Internal::Type::Boolean, true] => true,
      [Surge::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Surge::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Surge::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Surge::Internal::Type::Converter.new_coerce_state
      Surge::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Surge::Internal::Type::Converter.dump(target, input, state: state)
...
class Surge::Test::EnumModelTest < Minitest::Test
  class E0
    include Surge::Internal::Type::Enum
...
class Surge::Test::CollectionModelTest < Minitest::Test
  A1 = Surge::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Surge::Internal::Type::HashOf[Integer]

  A2 = Surge::Internal::Type::ArrayOf[H1]
  H2 = Surge::Internal::Type::HashOf[-> { A1 }]

  A3 = Surge::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Surge::Internal::Type::HashOf[Integer, nil?: true]
...
class Surge::Test::BaseModelTest < Minitest::Test
  class M1 < Surge::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Surge::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Surge::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Surge::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Surge::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Surge::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Surge::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Surge::Errors::ConversionError => e
...
class Surge::Test::UnionTest < Minitest::Test
  class U0
    include Surge::Internal::Type::Union
  ...
  class M2 < Surge::Internal::Type::BaseModel
  ...
  class M4 < Surge::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Surge::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Surge::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Surge::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Surge::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Surge::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [Surge::Internal::Type::Unknown, Surge::Internal::Type::Unknown] => true,
      [Surge::Internal::Type::Boolean, Surge::Internal::Type::Boolean] => true,
      [Surge::Internal::Type::Unknown, Surge::Internal::Type::Boolean] => false,
...
class Surge::Test::MetaInfoTest < Minitest::Test
  A1 = Surge::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Surge::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
