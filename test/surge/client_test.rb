...
class SurgeTest < Minitest::Test
  ...
  def test_client_default_request_default_retry_attempts
    stub_request(:post, "http://localhost/accounts/acct_01j9a43avnfqzbjfch6pygv1td/messages").to_return_json(
      status: 500,
      body: {}
    )

    surge = Surge::Client.new(base_url: "http://localhost", api_key: "My API Key")

    assert_raises(Surge::Errors::InternalServerError) do
  ...
  def test_client_given_request_default_retry_attempts
    ...
    surge = Surge::Client.new(base_url: "http://localhost", api_key: "My API Key", max_retries: 3)
  ...
  def test_client_retry_after_seconds
    ...
    surge = Surge::Client.new(base_url: "http://localhost", api_key: "My API Key", max_retries: 1)
  ...
  def test_client_redirect_307
    ...
    assert_raises(Surge::Errors::APIConnectionError) do
      surge.messages.create(
        "acct_01j9a43avnfqzbjfch6pygv1td",
        conversation: {contact: {phone_number: "+18015551234"}},
    ...
    assert_requested(:any, "http://localhost/redirected", times: Surge::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_303
    ...
    assert_requested(:get, "http://localhost/redirected", times: Surge::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_auth_strip_cross_origin
    ...
    assert_requested(:any, "https://example.com/redirected", times: Surge::Client::MAX_REDIRECTS) do
      headers = _1.headers.keys.map(&:downcase)
